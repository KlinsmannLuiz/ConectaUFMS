...
public class JPainelCapivara extends javax.swing.JPanel {

    
    private Image imagemLogo;
    
    public JPainelCapivara() {
        initComponents();
        setOpaque(false);
        carregarImagem();
    }
    ...
    public void carregarImagem() {
        try {
            imagemLogo = new ImageIcon(getClass().getResource("/Imagens/Capivara500px.png")).getImage();

            if (imagemLogo == null) {
                imagemLogo = new ImageIcon("/Imagens/Capivara500px.png").getImage();
            }
        } catch (Exception e) {
    ...
    public void redimencionandoTamanho(Graphics g) {
        ...
        if (imagemLogo != null) {
            ...
            int y = ((getHeight() + 150) - imagemLogo.getHeight(this)) / 2;
